"""
 ...
 2020 (c) piteren
    ...
    1. having some FUNCTION:
        ...
        - if function accepts 'device' or 'devices' it should be type of DevicesParam (check ptools.mpython.mptools),
          it will be used by hpmser to put proper device for each function call
        - returns a dict with 'score' or just a value (score)
    2. define PSDD - dictionary with parameters to be optimized and the space to search in (check ptools.pms.pasap.PaSpa)
